namespace Zipkin
{
	public static class AnnotationConstants
	{
		...
		/// </summary>
		/// <remarks>
		/// These annotations are used to derive span timestamps and durations or highlight common latency explaining events.
		/// </remarks>
		public static string[] CORE_ANNOTATIONS = new []
		{
			CLIENT_SEND, CLIENT_RECV,
			SERVER_SEND, SERVER_RECV,
			WIRE_SEND, WIRE_RECV,
			CLIENT_SEND_FRAGMENT, CLIENT_RECV_FRAGMENT,
			SERVER_SEND_FRAGMENT, SERVER_RECV_FRAGMENT
		};
	}
}